...
<body class="">
  <div class="wrapper">
    <div class="sidebar" data-color="white" data-active-color="danger">
      <div class="logo">
        <a href="tables.php" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="../assets/img/logo-small.png" />
          </div>
          <!-- <p>CT</p> -->
        </a>
        <a href="tables.php" class="simple-text logo-normal">
          MM COFFEE
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Laporan Penjualan Per Item</h4>
                <a href="export_lap_penjualan_item.php" target="_blank">
