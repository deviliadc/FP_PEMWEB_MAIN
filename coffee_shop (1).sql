...
(3, 'adminKasir', 'adminKasir001'),
(4, 'adminKasir', 'adminKasir002');
...
(3, 'liberica', 100000, 93, '2023-06-04 16:39:36', 'https://unsplash.com/photos/_QjXb8ZAte8'),
...
--
ALTER TABLE `stok_brg`
  MODIFY `stok_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
